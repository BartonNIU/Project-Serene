...
<!--                                            <li><a class="list" href="#"><i class="fa fa-list-ul"></i></a></li>-->
                                ...
                                <div class="listsearch-input-wrap fl-wrap">
                                    <div class="listsearch-input-item">
                                        ...
                                        <input type="text" name="postcode" placeholder="Postcode?" value="" id="search_text" class="form-control"/>
                                    </div>


                                    <div class="listsearch-input-item">
                                        <select multiple="multiple" name="value" data-placeholder="All Categories" class="chosen-select" id="value" >
...
<script>
    ...
    //     function filter_data()
    //     {
    //         $('.filter_data').html('<div id="result" style="" ></div>');
    //         var action = 'fetch';
    //         var facility = get_filter('facility');
    //         $.ajax({
    //             url:"fetch.php",
    //             method:"POST",
    //             data:{action:action, facility:facility},
    //             success:function(data){
    //                 $('.filter_data').html(data);
    //             }
    //         });
